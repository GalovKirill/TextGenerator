...
namespace TextGenerator.OldCode.SRTG1
{
    class Program
    {
        private const string Path = @"/home/galovkirill/texts/Гоголь/res.txt";
        private const string ValidSymbol = "абвгдёежзийклмнопрстуфхцчшщъыьэюя " +
        ...
        static void SomeProgramm()
        {
            ...
            EftagrammsCollection eftCollection = EftagrammsReader.GetEftagramms(text);            
